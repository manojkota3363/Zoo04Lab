...
import static edu.nwmissouri.zoo04lab.UtilityCheckFiles.getFileLines;
import java.io.File;
...
/**
 * Build our switch statement so we can see all the custom classes.
 *
 * @author Denise Case
 */
public class UtilityBuildSwitch {
    ...
    public static Map<Integer, String> getAllAnimalMap() {
        ...
        var animalMap = Collections.synchronizedMap(new TreeMap<Integer, String>());
